...
public class RegistrationExcelImport2 extends Tester {
    ...
    public void importAll() {
        ...
        String filepath = "C:\\Users\\liusu\\Desktop\\提交资料\\20201001-1206";
        try {
    ...
    public void imports(String filePath) {
        //String path = "C:\\Users\\liusu\\Desktop\\提交资料\\20201001-1206\\新天地店.xls";
        String clinicId = "";
        ...
        try {
            ...
            while (rows.hasNext()) {
                ...
                if(i>0){
                    ...
                    //1、预约  2、已确定  3、已到店 4已挂号 5、治疗中 6、治疗完成 7、已结账 8、已离开 9、已失约 10、咨询中 11、已取消
